...
uniform layout(location = 7) vec4 light_direction;
...
uniform layout(location = 12) float specular_shininess;
uniform layout(location = 13) float specular_strength;
...
void main()
{
    ...
    specular_factor = pow(specular_factor, specular_shininess) * specular_strength;
