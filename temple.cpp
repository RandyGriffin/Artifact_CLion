...
const static GLint u_ambient_light = 4;
const static GLint u_specular_light = 5;
const static GLint u_diffuse_light = 6;
const static GLint u_light_direction = 7;
const static GLint u_camera_position = 8;
const static GLint u_ambient_color = 9;
const static GLint u_specular_color = 10;
const static GLint u_diffuse_color = 11;
const static GLint u_specular_shininess = 12;
const static GLint u_specular_strength = 13;
